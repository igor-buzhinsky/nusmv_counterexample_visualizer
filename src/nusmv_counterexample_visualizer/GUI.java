...
public class GUI extends JFrame {
    ...
    private void createLowerPanel() {
        ...
        final java.util.List<String> lines = Arrays.asList(
                ...
                "by Igor Buzhinsky, Aalto University & ITMO University",
                "igor.buzhinsky@gmail.com",
                "",
                "The top panel lists LTL specifications from the input file.",
                "Visualization is available only for FALSE specifications.",
                "Select a FALSE specification to see the visualization of the",
                "counterexample for this specification in the middle panel.",
                "",
                "In the middle panel, the values (T, F) of each subformula of the LTL",
                "specification are shown for each step of the counterexample.",
                "Click on an annotation below a subformula to see an explanation",
                "of its value. As a result, this and some other values will be highlighted",
                "In addition, important atomic propositions are highlighted in the LTL formula.",
                "",
                "In the bottom panel, the values of all variables for all counterexample",
